...
\item \begin{tabular1bold} Google, Senior Engineer; Madison, WI & 2013 -- 2014 \end{tabular1bold}
  ...
  \item Exploratory hardware/software co-design; details confidential \hfill \emph{Verilog}
    ...
    \end{list3}
    \item Briefly consulted on a widget targeting 8-figure QPS on a single core \hfill \emph{C++}
  \end{list2}

\item \begin{tabular1bold} Hacker School, Sabbatical; New York, NY & Spring 2013 \end{tabular1bold}
